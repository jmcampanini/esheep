...
- Validate `esheep-` prefixed source entries but never install them or their descendants. Expand harness includes from the skill root, reject cycles, and preserve installed output when expansion fails.
